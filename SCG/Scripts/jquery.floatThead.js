            ...
            if(ieVersion === 8){
              ...
              if ($("body").hasClass('fullscreen')) {
                if ($(window).scrollTop() < 79) {
                  var transform = 'translateX(' + pos.left + 'px) translateY(' + (pos.top + $(window).scrollTop()) + 'px)';
                } else {
                  var transform = 'translateX(' + pos.left + 'px) translateY(' + (pos.top + 79) + 'px)';
                }
              } else if ($(window).scrollTop() < 269) {
                var transform = 'translateX(' + pos.left + 'px) translateY(' + (pos.top + $(window).scrollTop()) + 'px)';
              } else {
                var transform = 'translateX(' + pos.left + 'px) translateY(' + (pos.top + 269) + 'px)';
              }
              $floatContainer.css({
